          ...
          <ol className="flex w-full">
            {[
              ...
              <li className="flex w-full items-center" key={step.value}>
                ...
                >
                  <div
                    className={`mb-2 flex size-8 items-center justify-center rounded-full ${step.value === formStep ? 'bg-primary text-white' : index < ['personal', 'contact', 'emergency', 'medical', 'administrative'].indexOf(formStep) + 1 ? 'bg-primary/20 text-primary' : 'bg-muted text-muted-foreground'}`}
                  >
                    {index <
                    [
                      'personal',
                ...
                {index < 4 && (
                  <div
                    className={`mx-2 h-px flex-1 ${index < ['personal', 'contact', 'emergency', 'medical', 'administrative'].indexOf(formStep) ? 'bg-primary' : 'bg-muted'}`}
                  />
                )}
              </li>
            ))}
        ...
        {formStep === 'emergency' && (
          <Card className="p-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm">
                Provide emergency contact information for the patient.
              </p>
        ...
        {formStep === 'administrative' && (
          <Card className="p-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm">
                Enter administrative and insurance details.
              </p>
