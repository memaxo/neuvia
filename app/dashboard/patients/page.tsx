          ...
          <div className="relative space-y-6">
            ...
            <div className="relative overflow-hidden rounded-xl border border-[rgb(var(--border))/var(--opacity-10)] bg-[rgb(var(--background))/var(--opacity-40)] p-6 backdrop-blur-sm">
              <div className="flex items-center justify-between">
                ...
                <Button className="duration-normal group relative overflow-hidden bg-[rgb(var(--primary))] text-white shadow-lg transition-all hover:bg-[rgb(var(--primary-dark))] hover:shadow-[0_0_30px_rgba(var(--primary),0.3)]">
            ...
            <div className="relative overflow-hidden rounded-xl border border-[rgb(var(--border))/var(--opacity-10)] bg-[rgb(var(--background))/var(--opacity-40)] p-6 backdrop-blur-sm">
              <div className="flex items-center gap-4">
                ...
                <div className="group relative flex-1">
                  <div className="duration-normal relative overflow-hidden rounded-xl backdrop-blur-sm transition-all group-focus-within:shadow-[0_0_30px_rgba(var(--primary),0.1)]">
                    <Search className="duration-normal absolute left-4 top-1/2 size-4 -translate-y-1/2 text-[rgb(var(--foreground))/var(--opacity-40)] transition-colors group-focus-within:text-[rgb(var(--primary))]" />
                    <Input
                      className="duration-normal h-11 w-full border-[rgb(var(--border))/var(--opacity-10)] bg-[rgb(var(--background))/var(--opacity-40)] pl-11 text-base text-[rgb(var(--foreground))/var(--opacity-70)] transition-all placeholder:text-[rgb(var(--foreground))/var(--opacity-40)] focus:border-[rgb(var(--primary))/var(--opacity-30)] focus:ring-2 focus:ring-[rgb(var(--primary))/var(--opacity-20)]"
                      placeholder="Search patients by name, ID, or status..."
                      type="search"
                    />
                    <div className="duration-normal absolute inset-0 overflow-hidden opacity-0 transition-opacity group-focus-within:opacity-100">
