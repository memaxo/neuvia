...
export function PatientDocumentTimeline({ patientId, documents = [] }: PatientDocumentTimelineProps) {
  ...
  const timelineEntries = Object.values(groupedDocuments).sort((a, b) => 
                          ...
                          <div className="bg-card rounded-lg border p-4 shadow-sm">
                            <div className="mb-2 flex items-center justify-between">
                              ...
                              <TooltipProvider>
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p className="capitalize">{doc.processing_status}</p>
                                  </TooltipContent>
                                </Tooltip>
                              </TooltipProvider>
                            </div>
                            ...
                            <div className="text-muted-foreground mb-3 text-sm">
                              ...
                              <div className="mt-1 flex items-center gap-2">
                                <Badge className="capitalize" variant="outline">{doc.category || 'Other'}</Badge>
                                <Badge className="capitalize" variant="secondary">{doc.document_type?.type || 'Unknown'}</Badge>
                              </div>
                            </div>
