    ...
    <div className="flex-1 space-y-8">
      ...
      <div className="relative max-w-2xl">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 rounded-md bg-teal-800/50 text-teal-100 placeholder:text-teal-300 border border-teal-700 focus:outline-none focus:ring-2 focus:ring-cyan-500"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-teal-800/50 rounded-lg p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-teal-100">AI Analysis</h3>
          </div>
        ...
        <div className="bg-teal-800/50 rounded-lg p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-teal-100">Document Summary</h3>
          </div>
          <p className="text-teal-300">
        ...
        <div className="bg-teal-800/50 rounded-lg p-6 md:col-span-2">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-teal-100">Clinical Alerts</h3>
          </div>
          <p className="text-teal-300">
